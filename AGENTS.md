...
- `just deps-audit` must pass before claiming release readiness.
...
- Keep stable QA and runtime practices in
  [`docs/BEST_PRACTICES.md`](docs/BEST_PRACTICES.md); keep this file compact.
